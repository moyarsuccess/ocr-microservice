...
class TesseractService(
    @param:Value("\${tesseract.datapath:/usr/share/tessdata}")
    private val dataPath: String,

    @param:Value("\${tesseract.language:eng}")
    ...
    override fun extractTextFromImage(imageStream: InputStream): String {
    ...
    override fun extractTextFromPdf(pdfStream: InputStream): String {
        val start = System.currentTimeMillis()
        return try {
